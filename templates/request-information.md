...
2. Consider only unresolved blocking questions owned by the developer, grounded in the assessment or investigation evidence. Remove questions answered by current issue fields, developer replies, or Kubernetes/Jenkins findings. Exclude operator/tool limitations and information that is merely helpful.
