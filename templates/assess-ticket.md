...
- scope: service, environment, cluster_context, namespace, time_window (null for unknowns).
...
- questions: objects with field, question, why_needed, answer_example, blocking (boolean), owner (developer or operator), discoverable_via (kubernetes, jenkins, or none), and already_requested (boolean).
